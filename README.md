...
| CrossOver evidence | Root `C:\Shandalar\Shandalar.exe` reached the main menu and the default/first start-color path reached the adventure map in `MTG`; the current bottle state validates as app-default `win7` with `Shandalar1440=1440x1080`, but full gameplay still needs visible manual testing. |
