...
| `list-branch-delta.sh` | Lists tracked branch changes relative to `master` as TSV with status, path, coarse kind, byte count, and SHA-256 for review or patch-only release planning. |
