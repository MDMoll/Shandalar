...
check_marker "cards/zendikar.c" "if (ai_preselect_player_target_for_cip(player, card, event, 1-player, 0))" "piranha-marsh-ai-etb-immediate"
...
check_marker "cards/worldwake.c" "if (ai_preselect_player_target_for_cip(player, card, event, 1-player, 0))" "bojuka-bog-ai-etb-immediate"
