...
check_marker "cards/zendikar.c" "comes_into_play_mode(player, card, event, RESOLVE_TRIGGER_AI(player))" "piranha-marsh-ai-etb-trigger-mode"
check_marker "cards/worldwake.c" "pick_player_duh(player, card, 1-player, 0)" "bojuka-bog-ai-target"
check_marker "cards/worldwake.c" "comes_into_play_mode(player, card, event, RESOLVE_TRIGGER_AI(player))" "bojuka-bog-ai-etb-trigger-mode"
