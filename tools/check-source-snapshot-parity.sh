...
is_marker_checked_path() {
  local relpath="$1"
  case "$relpath" in
    cards/avacyn_restored.c|cards/draft.c|cards/worldwake.c|cards/zendikar.c|functions/deck.c|functions/exiledby.c|functions/functions.c|functions/manipulate_and_damage_all.c|functions/show_backtrace.c|functions/targets.c|functions/produce_mana.c|functions/token_generation.c|functions/tutors.c|drawcardlib/config.c)
      return 0
      ;;
    *)
      return 1
...
check_marker "functions/targets.c" "int ai_preselect_player_target_for_cip" "ai-etb-preselect-helper"
check_marker "functions/targets.c" "EVENT_END_TRIGGER" "ai-etb-end-trigger-defer"
check_marker "functions/targets.c" "set_preferred_player_target_if_valid" "ai-etb-no-ui-target-helper"
check_marker "functions/targets.c" "trigger_condition == TRIGGER_COMES_INTO_PLAY" "ai-etb-trigger-guard"
...
check_marker "cards/zendikar.c" "ai_preselect_player_target_for_cip(player, card, event, 1-player, 0)" "piranha-marsh-ai-etb-preselect"
check_marker "cards/zendikar.c" "AI_PLAYER_TARGET_CIP_RESOLVE" "piranha-marsh-ai-etb-end-resolve"
check_marker "cards/zendikar.c" "AI_PLAYER_TARGET_CIP_SUPPRESS_TRIGGER" "piranha-marsh-ai-etb-suppress-trigger"
check_marker "cards/worldwake.c" "pick_player_duh(player, card, 1-player, 0)" "bojuka-bog-ai-target"
check_marker "cards/worldwake.c" "ai_preselect_player_target_for_cip(player, card, event, 1-player, 0)" "bojuka-bog-ai-etb-preselect"
check_marker "cards/worldwake.c" "AI_PLAYER_TARGET_CIP_RESOLVE" "bojuka-bog-ai-etb-end-resolve"
check_marker "cards/worldwake.c" "AI_PLAYER_TARGET_CIP_SUPPRESS_TRIGGER" "bojuka-bog-ai-etb-suppress-trigger"
