...
EXPECTED_HEX_PREFIXES = {
    ...
    "ManalinkEh.dll": [
        ...
        (0x495B00, bytes.fromhex("53e83a68f9ff83c40485c0b8010000007405b80200000050575653e8b0e9f9ff83c410c3")),
    ],
    "Program/ManalinkEh.dll": [
        ...
        (0x452D00, bytes.fromhex("53e89ac5f9ff83c40485c0b8010000007405b80200000050575653e8503bfaff83c410c3")),
    ],
}
