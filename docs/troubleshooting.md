...
| Runtime DLLs are patched too. | Root `ManalinkEh.dll` is patched at file offsets `0x3bb035`, `0x44cb23`, `0x495a30`, `0x40d0e1`, `0x495a60`, `0x40db84`, `0x495a90`, and `0x3fe7a0`; `Program/ManalinkEh.dll` is patched at `0x381a25`, `0x40f115`, `0x452c30`, `0x3d2da1`, `0x452c60`, `0x3d3844`, `0x452c90`, and `0x3c4930`. |
...
| Retest a duel where the opponent plays Piranha Marsh. | The runtime now routes that ETB trigger through `pick_player_duh()` to avoid a generic player-target prompt during AI-controlled trigger resolution. |
| Retest a duel where the opponent plays Bojuka Bog. | The runtime now routes that ETB trigger through `pick_player_duh()` for the same AI-controlled player-target trigger class. |
