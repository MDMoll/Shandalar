...
| `clamscan --fail-if-cvd-older-than=7 --file-list=/private/tmp/shandalar-security-scan-target-paths-38300383.txt --log=/private/tmp/shandalar-clamscan-38300383.log` | ClamAV `1.5.2/28017/Sun May 31 02:27:13 2026` scanned 241 tracked security targets and reported `Infected files: 0`; `tools/verify-security-scan-results.sh --results security-scan-results.tsv --require-all` validated 241 local TSV rows. |
