...
the name-entry default buffer, name-editor bypass/fallback, same-arrow
adventure-map stop behavior, MagSnd update-message compatibility path, and
WinMM timer-callback compatibility path,
