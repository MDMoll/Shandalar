...
| `shasum -a 256 ManalinkEh.dll Program/ManalinkEh.dll` | repo root | Root patched hash is `c5e34db93b28bfc1552782f2035814cb847b9ca76d8dd7abe8b3770070bfa32e`; `Program/` patched hash is `1de106b5f8d62cd7942c8da2086a60ba96932501f97fc363e0f51878ef4bdf47`. |
...
| `xxd -p -l 117 -s $((0x3f63e0)) ManalinkEh.dll` and `xxd -p -l 117 -s $((0x3bc630)) Program/ManalinkEh.dll` | repo root | Bojuka Bog's ETB trigger calls `pick_player_duh()` so AI/Duh mode targets the opponent before exiling that player's graveyard. |
