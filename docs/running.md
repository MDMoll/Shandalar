...
| `shasum -a 256 ManalinkEh.dll Program/ManalinkEh.dll` | repo root | Root patched hash is `98e067759a5c76f486e67c197d6522be570f717e449ae274e954a8fe99bf023f`; `Program/` patched hash is `86c733876b85029e489e69add6ff923322653670423214ccfcc544fc4ee871ba`. |
...
| `xxd -p` checks at `0x3f63bd`/`0x3fe77d`/`0x495b00` for root `ManalinkEh.dll` and `0x3bc60d`/`0x3c490d`/`0x452d00` for `Program/ManalinkEh.dll` | repo root | Piranha Marsh and Bojuka Bog immediately resolve the exact non-speculating AI land ETB effect during `EVENT_TRIGGER`, before normal `comes_into_play()` trigger priority. Fresh manual Bojuka proof is still pending. |
