...
| [bugs/ai-etb-player-target-spell-chain-freeze.md](bugs/ai-etb-player-target-spell-chain-freeze.md) | Piranha Marsh/Bojuka Bog ETB player-target Spell Chain freeze investigation and patch evidence. |
