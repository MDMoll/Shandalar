...
| [bugs/ai-etb-player-target-spell-chain-freeze.md](bugs/ai-etb-player-target-spell-chain-freeze.md) | AI-controlled ETB player-target Spell Chain freeze investigation, failed Bojuka selector retest, and immediate-resolution patch evidence. |
