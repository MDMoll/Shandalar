...
| Automated non-gameplay checks | Repo share-readiness checks are repeatable without launching the game, including maintained-text ASCII and local Markdown link validation. | `tools/verify-share-readiness.sh`. |
