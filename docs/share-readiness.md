...
| Cleanup test plan | Risky remaining moves have a disposable launch-copy test plan and a helper that creates a checked full-copy target without overwriting existing paths. | [cleanup-launch-copy-test.md](cleanup-launch-copy-test.md), `tools/create-cleanup-test-copy.sh`. |
