...
| Patch-only planning | A branch-delta inventory helper and restoration-test plan exist, but no patch package is prepared yet. | [patch-package-plan.md](patch-package-plan.md), `tools/list-branch-delta.sh`. |
...
| A patch/docs-only public package exists. | [patch-package-plan.md](patch-package-plan.md) records the inventory and restoration-test plan, but no package artifact has been created or tested. |
