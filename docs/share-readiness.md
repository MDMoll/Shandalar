...
| ClamAV security scan | ClamAV `1.5.2/28017/Sun May 31 02:27:13 2026` scanned the 241 tracked security targets and reported zero infected files; the ignored local `security-scan-results.tsv` validates against current hashes. | [security-scan.md](security-scan.md), [generated/security-scan/clamav-2026-05-31.md](generated/security-scan/clamav-2026-05-31.md), `tools/verify-security-scan-results.sh --results security-scan-results.tsv --require-all`. |
| First gameplay smoke row | Root `C:\Shandalar\Shandalar.exe` reaching the main menu is recorded, while the new-game, save/load, duel, and regression rows remain open. | S1 in [manual-gameplay-verification.md](manual-gameplay-verification.md), [running.md](running.md), and [verified-on-this-machine.md](verified-on-this-machine.md). |
...
| Claim | Why not yet |
| --- | --- |
| The game is fully gameplay-verified on CrossOver. | Only launch-to-main-menu is recorded as passed. Visible manual testing still needs to confirm character creation, same-arrow map stop, save/load, duel stability, and all five starting colors; see [manual-gameplay-verification.md](manual-gameplay-verification.md). |
