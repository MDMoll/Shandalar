...
| Git handoff | Branch, remote, pre-push checks, known auth failure, owner-side auth paths, Git bundle fallback, and bundle checksum sidecar are recorded. | [git-handoff.md](git-handoff.md), [push-auth.md](push-auth.md), `tools/create-git-handoff-bundle.sh`. |
