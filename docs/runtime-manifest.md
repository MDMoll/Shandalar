...
| --- | --- | --- | --- |
| `Shandalar.exe` | `c0d3607d991c976a2302880fb3cb341c096b570935bf0f27b91a732b45119a2b` | PE32 GUI Intel 80386 | Root CrossOver launch target; patched for DIB, name, movement, WinMM timer-callback compatibility, MagSnd update-message callback compatibility, and MagSnd initialization-disable behavior. |
| `Program/Shandalar.exe` | `c0d3607d991c976a2302880fb3cb341c096b570935bf0f27b91a732b45119a2b` | PE32 GUI Intel 80386 | Same bytes as root, including the WinMM timer-callback, MagSnd update-message, and MagSnd initialization-disable compatibility patches; adjacent `Program/zlib.dll`, Program helper DLLs, `Program/libgcc_s_dw2-1.dll`, Program config, font, card-data, and CardArt assets observed so far are now present in this checkout and the local copied install, but the direct copied-bottle Program path still needs visible retesting. |
