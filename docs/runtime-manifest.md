...
| --- | --- | --- | --- |
| `Shandalar.exe` | `17f7af843fd2fd5424e7d36d547f4315d20fdfa840fb5050a96ab9a727a181f6` | PE32 GUI Intel 80386 | Root CrossOver launch target; patched for DIB, name, movement, minimal WinMM timer-callback compatibility, MagSnd update-message callback compatibility, and MagSnd initialization-disable behavior. |
| `Program/Shandalar.exe` | `17f7af843fd2fd5424e7d36d547f4315d20fdfa840fb5050a96ab9a727a181f6` | PE32 GUI Intel 80386 | Same bytes as root, including the minimal WinMM timer-callback, MagSnd update-message, and MagSnd initialization-disable compatibility patches; adjacent `Program/zlib.dll`, Program helper DLLs, `Program/libgcc_s_dw2-1.dll`, Program config, font, card-data, and CardArt assets observed so far are now present in this checkout and the local copied install, but the direct copied-bottle Program path still needs visible retesting. |
