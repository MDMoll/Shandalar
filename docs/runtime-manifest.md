...
| `ManalinkEh.dll` | `7cb25032ee48c973b6e5ce17195607b5e3472ea457d60cc9421c320becadd927` | PE32 DLL Intel 80386 | Root DLL patched for Samite-family damage-prevention activation, generic activated damage-prevention gating, AI decision-time clamping, AI raw-mana speculation snapshot restore safety, Piranha Marsh/Bojuka Bog AI trigger targeting, generic AI player-only target selection, and AI ETB player-target end-trigger land resolution. |
| `Program/ManalinkEh.dll` | `f0a399ae7a8d65144f0d9bafff5a9287140c7c056fa0468d1cd9b5b07f3404d4` | PE32 DLL Intel 80386 | Program DLL patched at its own offsets for Samite-family damage-prevention activation, generic activated damage-prevention gating, AI clamping, AI raw-mana speculation snapshot restore safety, Piranha Marsh/Bojuka Bog AI trigger targeting, generic AI player-only target selection, and AI ETB player-target end-trigger land resolution. |
