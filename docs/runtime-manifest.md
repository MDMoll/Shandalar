...
| --- | --- | --- | --- |
| `Shandalar.exe` | `92cca05b493c28f6c29c0cc4bd0018499acd9a8cbdce06f9230da59d5be0a0ef` | PE32 GUI Intel 80386 | Root CrossOver launch target; patched for DIB, name, movement, and WinMM timer-callback compatibility behavior. |
| `Program/Shandalar.exe` | `92cca05b493c28f6c29c0cc4bd0018499acd9a8cbdce06f9230da59d5be0a0ef` | PE32 GUI Intel 80386 | Same bytes as root, including the WinMM timer-callback compatibility patch; adjacent `Program/zlib.dll`, Program helper DLLs, `Program/libgcc_s_dw2-1.dll`, Program config, font, card-data, and CardArt assets observed so far are now present in this checkout and the local copied install, but the direct copied-bottle Program path still needs visible retesting. |
