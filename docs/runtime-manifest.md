...
| --- | --- | --- | --- |
| `Shandalar.exe` | `bec1dd2bba524618529d674e3a927f4aa93f53a39a444dd3d6d425856f8c1b32` | PE32 GUI Intel 80386 | Root CrossOver launch target; patched for DIB, name, movement, WinMM timer-callback compatibility, and MagSnd update-message callback compatibility behavior. |
| `Program/Shandalar.exe` | `bec1dd2bba524618529d674e3a927f4aa93f53a39a444dd3d6d425856f8c1b32` | PE32 GUI Intel 80386 | Same bytes as root, including the WinMM timer-callback and MagSnd update-message compatibility patches; adjacent `Program/zlib.dll`, Program helper DLLs, `Program/libgcc_s_dw2-1.dll`, Program config, font, card-data, and CardArt assets observed so far are now present in this checkout and the local copied install, but the direct copied-bottle Program path still needs visible retesting. |
