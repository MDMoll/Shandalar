...
| `ManalinkEh.dll` | `98e067759a5c76f486e67c197d6522be570f717e449ae274e954a8fe99bf023f` | PE32 DLL Intel 80386 | Root DLL patched for Samite-family damage-prevention activation, generic activated damage-prevention gating, AI decision-time clamping, AI raw-mana speculation snapshot restore safety, Piranha Marsh/Bojuka Bog AI trigger targeting, generic AI player-only target selection, and immediate AI ETB player-target land resolution before Spell Chain priority. |
| `Program/ManalinkEh.dll` | `86c733876b85029e489e69add6ff923322653670423214ccfcc544fc4ee871ba` | PE32 DLL Intel 80386 | Program DLL patched at its own offsets for Samite-family damage-prevention activation, generic activated damage-prevention gating, AI clamping, AI raw-mana speculation snapshot restore safety, Piranha Marsh/Bojuka Bog AI trigger targeting, generic AI player-only target selection, and immediate AI ETB player-target land resolution before Spell Chain priority. |
