...
| `clamscan --fail-if-cvd-older-than=7 --file-list=/private/tmp/shandalar-security-scan-target-paths-s2.txt --log=/private/tmp/shandalar-clamscan-s2.log` | `Scanned files: 241`; `Infected files: 0`; `Known viruses: 3627865`; start `2026:05:31 20:19:40`, end `2026:05:31 20:20:36`. | ClamAV reported no infected files for the exact tracked security-target inventory after the S2 evidence update. See [generated/security-scan/clamav-2026-05-31.md](generated/security-scan/clamav-2026-05-31.md). |
...
| --- | --- | --- | --- | --- | --- |
| 2026-05-31 | ClamAV `1.5.2/28017/Sun May 31 02:27:13 2026` | 241 tracked security-scan targets from `tools/list-security-scan-targets.sh` | Validated locally by `tools/verify-security-scan-results.sh --results security-scan-results.tsv --require-all` | Clean | `clamscan --fail-if-cvd-older-than=7 --file-list=/private/tmp/shandalar-security-scan-target-paths-s2.txt --log=/private/tmp/shandalar-clamscan-s2.log` reported `Scanned files: 241` and `Infected files: 0`. |
