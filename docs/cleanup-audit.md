...
| --- | --- |
| Definitely generated/recreatable | `archive/generated-local/Duel.GID`, generated/log/debug files, extensionless `MAGIC5`, and empty `Program/Savedescs`. `CardArtNew/Thumbs.db` was removed in the safe duplicate cleanup pass. |
