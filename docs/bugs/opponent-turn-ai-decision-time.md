...
player-target selector, and AI land CIP resolver stack-bypass handling patches in the
same DLLs.
...
Piranha Marsh trigger-target, Bojuka Bog trigger-target, generic AI
player-target selector, and AI land CIP resolver stack-bypass handling patches. The local
